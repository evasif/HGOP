...
//getCardsValue
test('the highest score the cards can yield should be equal to 21', () => {
  let deck = deckConstructor();
  deck = [
    '01D', '10S', '10H',
  ];
...
//getCardsValue
test('the highest score the cards can yield should be equal to 18', () => {
  let deck = deckConstructor();
  deck = [
    '02D', '05S', '01H',
  ];
...
//getTotalValue
test('sum of drawn cards should equal 25', () => {
  let deck = deckConstructor();
  deck = [
    '05D', '10S', '10H',
  ];
